...
def score_short_answer(gold_label_list, pred_label):
  ...
  #print(gold_has_answer)
  #print(pred_has_answer)
  #print("\n")
  if gold_has_answer and pred_has_answer:
    #print("yes")
    if pred_label.yes_no_answer != 'none':  # System thinks its y/n questions.
      ...
      for gold_label in gold_label_list:
        #print(pred_label.yes_no_answer)
        #print(gold_label.yes_no_answer)
        #print("\n")
      ...
      print("pred:")
      print(pred_label.short_answer_span_list)
      print("gold:")
      for gold_label in gold_label_list:
        print(gold_label.short_answer_span_list)
